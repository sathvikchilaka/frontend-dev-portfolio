...
import "./header.css";
import logo from "../../assets/supabase-logo-wordmark--dark.png";
    ...
    <header className="header">
      <nav>
        <div className="nav-options">
          <img src={logo} alt="Supabase Logo" className="logo" />
          <a className="navbar-options" href="#features">
            Home
          </a>
          <a className="navbar-options" href="#pricing">
            Skills
          </a>
        ...
        <div className="github-action-btn">
          <svg className="github-btn" fill="none">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
